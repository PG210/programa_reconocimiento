        ...
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
          <tr>
            <td align="center" style="padding:20px 0 20px 0;background:#08FFD5;">
             ...
             <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">¡Felicidades! <span style="color:#Ffbd03;">  @if(isset($datosrec)) {{$datosrec->nomrecibe}} {{$datosrec->aperecibe}} @endif</span></h1>
            </td>
          </tr>
          <tr>
