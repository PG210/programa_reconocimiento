        ...
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
          <tr>
            <td align="center" style="padding:10px 0 10px 0; background:#6D7274;">
             ...
             <h1 style="font-size:24px;margin:0 0 10px 0;font-family:Arial,sans-serif; color:white;">¡Felicidades! <span style="color:white;"> </span></h1>
            </td>
          </tr>
          <tr>
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">    
                <tr>
                  <td style="padding:0 0 10px 0;color:#153643;">
                    <h1 style="font-size:18px;margin:0 0 15px 0;font-family:Arial,sans-serif;"><span style="color:#Ffbd03;"></h1>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0;">
                        ...
                        <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                         ...
                         <form class="form1 letraform" style="font-size:14px;font-family:Arial,sans-serif; text-align: justify;">
                           <div class="container">
                            ...
                            <label for="firstName" class="first-name">@if(isset($detalle)) {{$detalle}} @endif</label>
                            <br>
                          </div>
                          <hr>
                          <div class="container">
                          ...
                          <div class="container">
                            ...
                            <label for="age">@if(isset($puntos)){{$puntos}}@endif</label>
                          </div>
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;font-size:9px;font-family:Arial,sans-serif;">
                <tr>
                  <td style="padding:0;width:50%;" align="left">
                   ...
                   <label style="margin:0;font-size:14px;line-height:16px;font-family:Arial,sans-serif;color:black;" ></label>
                  </td>
