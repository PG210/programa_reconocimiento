        ...
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
          <tr>
            <td align="center" style="padding:20px 0 20px 0;background:#08FFD5;">
             ...
             <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">¡Felicidades! <span style="color:#Ffbd03;">@if(isset($datosin)){{$datosin->nomrecibe}} {{$datosin->aperecibe}}@endif</span></h1>
            </td>
          </tr>
          <tr>
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">    
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    <h1 style="font-size:18px;margin:0 0 15px 0;font-family:Arial,sans-serif; text-align: justify;"> Acabas de ganar una Insignia nivel: <span style="color:#Ffbd03;">@if(isset($datosin)){{$datosin->nivel}}@endif</span>.</h1>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0;">
