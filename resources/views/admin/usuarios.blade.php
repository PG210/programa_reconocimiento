...
@section('content')
  ...
  <div class="container">
    ...
    <div class="col-12">
      ...
      ⚠️ <strong>Licencias vencidas:</strong> Tu licencia expiró el <b>{{$fecha}}</b>. Por favor, renueva para
      continuar.
      </div>
    @endif
    </div>
  ...
  @if($totaluser < $licencias->numlicencia)
    ...
    <a type="button" class="small-box-footer" data-toggle="collapse" href="#regusuarioindi" role="button"
    ...
    <a type="button" class="small-box-footer" data-toggle="modal" data-target="#carga">Sube tu archivo <i
...
@endif
    ...
    @endif
      ...
      <a href="/areas/empresa" class="small-box-footer">Asignar más <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
        ...
        <div class="col-12 collapse mt-2" id="regusuarioindi">
          ...
          <form method="POST" action="{{route('addUser')}}">
            ...
            <div class="col-sm-4 col-lg-4">
              ...
              minlength="10" pattern="\+[0-9]{10,15}" placeholder="+573109006780" required>
            </div>
            </div>
            <div class="form-group row">
            ...
            <div class="col-sm-4 col-lg-4">
              ...
              <input type="password" class="form-control" id="pass" name="pass" aria-label="Username"
        ...
        <div class="modal fade" id="carga" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="input-group mb-3">
              ...
              <input type="file" class="form-control" name="archivosubido" id="archivosubido"
                placeholder="elegir"
        ...
        <table class="table table-hover table-estadisticas" id="votacion">
          ...
          @foreach($lista as $c)
              ...
              <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                ...
                <a href="{{route('actualizaruser', $c->id)}}" data-toggle="tooltip" data-placement="bottom"
                class="btn btn-outline-primary btn-sm" title="Editar"><i class="fas fa-edit"></i></a>

                <!--#######################################3-->
                @if($c->rol != 'admin')
              <!--modal eliminar -->
              <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal"
              data-target="#eliminarUser{{$c->id}}">
              <i class="fas fa-trash-alt"></i>
              </button>
              <!--==========================-->
              <div class="modal fade" id="eliminarUser{{$c->id}}" tabindex="-1"
              aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <p>
                        ¿Seguro que quieres eliminar el usuario "{{$c->name}} {{$c->apellido}}"?
                      </p>
                      </div>
                      <div class="modal-footer justify-content-between">
                        ...
                        <form action="{{ route('eliminaruser') }}" method="POST">
                          @csrf
                          <input type="hidden" name="iduser" id="iduser{{$c->id}}" value="{{$c->id}}">
            ...
            title="{{ $c->esta == 'habilitado' ? 'Deshabilitar' : 'Habilitar' }}">
            <i class="nav-icon fas fa-toggle-{{ $c->esta == 'habilitado' ? 'on' : 'off' }}"
            style="color: {{ $c->esta == 'habilitado' ? '#64e108' : '#9cbe82' }}; font-size:20px;"></i>
            </a>
          @else
          ...
          @endif
              ...
              <div class="modal fade" id="cambiarPro{{ $c->id }}" tabindex="-1" role="dialog"
                ...
                <a class="btn btn-success confirmar"
                  href="{{ route('cambiarestado', $c->id) }}">Modificar</a>
