...
@endif
    ...
    <div class="col-12">
      ...
      <div class="px-3 mb-2 mt-5">
        ...
        <div class="table-responsive">
          ...
          <thead>
            ...
            <th scope="col">
              ...
              <button type="submit" class="btn btn-info btn-sm"><i class="fas fa-hand-pointer"></i>
                Postular</button>
              </div>
            </th>
            </tr>
        ...
        <td>
          <div class=" text-center">
          <input class="" type="checkbox" value="{{$usu->idusu}}" id="defaultCheck1{{$usu->idusu}}"
          name="user[]" @if($usu->postulado == '1') checked @endif>
          </div>
        </td>
        </tr>
      @endforeach
